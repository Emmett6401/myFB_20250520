...
Form, Window = uic.loadUiType("res/dialog.ui")
...
def on_save_button_clicked():
    ...
    try:
        # with open("addbook.csv", mode="a", newline="", encoding="utf-8") as file:
        with open("data/addbook.csv", mode="a", newline="", encoding="utf-8") as file:
